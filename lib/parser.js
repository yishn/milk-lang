...
parseExpression = function() {
    ...
    } else if ((kk = searchTokens.apply(this, (function() {
        var r3, i8, l4, x4;
        r3 = [];
    ...
    } else if (((k = searchTokenL.apply(this, (function() {
        var r4, i10, l6, x5;
        r4 = [];
...
parseKeyValuePair = function(tokens) {
    ...
    while (pointer < tokens.length) {
        ...
        /*@555:9*/
        token = tokens[pointer];
        if (((token[0] === 'rightdelimiter') || (token[0] === 'newline')) || (equals(token, ['delimiter', ',']))) {
            if (output.length > 2) {
                /*@560:35*/
                throw {
...
parseStatement = function(tokens) {
    ...
    } else if (((token[0] === 'keyword') && (!equals(token, ['keyword', 'function']))) && statementKeywords.every(function(x) {
        return !equals(x, token);
    })) {
        throw {
