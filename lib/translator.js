...
ifStatement = function(tree) {
    var code, vars, output, i20, l15, condition, s, i;
    /*@752:5*/
...
chainCmp = function(tree) {
    var temps, s, i21, l16, x, i, expr, start2, end2, step2;
    /*@814:5*/
    temps = [];
    s = ['statements'];
    l16 = tree;
...
arraypattern = function(tree, ref) {
    var s, spreadindex, hasSpread, i22, l17, node, i, i23, l18;
    /*@880:5*/
    s = ['statements'];
