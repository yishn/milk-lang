...
helperFunctions = function() {
    ...
    if (exports.flags['compose'] != null) {
        output.push(formatCode([exports.flags['compose'] + ' = function(x, y) {', ['return function() {', ['if (arguments.length === 0)', ['return x(y());'], 'else if (arguments.length === 1)', ['return x(y(arguments[0]));'], 'return x(y.apply(this, arguments));'], '}'], '}']));
    };
    /*@74:5*/
...
object = function(tree) {
    var key, value, fortrees, temp, s, ref, i13, l10, t, i;
    /*@450:5*/
    if (tree[0] !== 'objectfor') {
        if (tree.length === 1) {
            return '{}';
        ...
        /*@452:9*/
        return formatCode(['{', tree.slice(1).map(function(x, i) {
            return ((expression(x[0]) + ': ') + expression(x[1])) + ((i === (tree.length - 2)) ? '' : ',');
        }), '}']);
    };
    (function(ref10) {
        (function(ref11) {
        ...
        fortrees = (2 >= ref10.length) ? [] : [].slice.call(ref10, 2);
        return ref10;
    })(tree);
    /*@457:5*/
    temp = ['identifier', getVarName('r')];
...
funcCall = function(tree) {
    ...
    if (placeholderCount === 0) {
        if (!hasSpread) {
            ...
            /*@538:13*/
            output = function(token) {
                return ['()', ['.', token, ['identifier', 'apply']], ['array', ['keyword', 'this'], args]];
            };
        };
    } else {
        var temps;
...
func = function(tree) {
    ...
    if (!isProperPattern) {
        vars = vars.filter(function(x) {
            return !args.slice(1).some(function(y) {
                return y[0][1] === x;
            });
        });
    };
...
ifStatement = function(tree) {
    var code, vars, output, i16, l13, node, i;
    /*@719:5*/
...
chainCmp = function(tree) {
    var temps, s, i17, l14, x, i, expr, start2, end2, step2;
    temps = [];
    s = ['statements'];
    /*@781:5*/
    l14 = tree;
...
arraypattern = function(tree, ref) {
    var s, spreadindex, hasSpread, i18, l15, node, i, i19, l16;
    /*@844:5*/
    s = ['statements'];
...
classStatement = function(tree) {
    ...
    s.push.apply(this, (function() {
        var r14, i21, l18, x9;
        r14 = [];
        l18 = enumerate(functions.filter(function(f) {
