...
exports.tokenize = function(input) {
    var residue, offset, tokens, output, indents, indentLength, lastDepth, useTabs, i6, l5, type, value, i, start2, end2, step2, i7, l6, token, indent;
    (function(ref2) {
        residue = ref2[0];
        offset = ref2[1];
        return ref2;
    ...
    indent = ((function() {
        var r6, start3, end3, step3, x3;
        r6 = [];
        start3 = 1;
        end3 = indentLength;
        step3 = (end3 === start3) ? 1 : Math.sign(end3 - start3);
        for (x3 = start3; step3 > 0 ? x3 <= end3 : x3 >= end3; x3 += step3) {
            r6.push(useTabs ? '\t' : ' ');
        };
        return r6;
    })()).join('');
